...
/*
    ...
    This class is a derivated work from AsyncHttpResponseHandler class
    contained in Android-Async-Http.

    The only modification that I applied is that I force the Response
    Handler to use synchronous mode directly in the contructor, because
    the method setUseSynchronousMode sometimes in uneffective.

    I forced this simply changing the line "setUseSynchronousMode(false)"
    in both the constructors to "setUseSynchronousMode(true)".
 ...
 * client.get("https://www.google.com", new ResponseHandler() {
 *     &#064;Override
 *     public void onStart() {
...
public abstract class ResponseHandler implements ResponseHandlerInterface {
    ...
    /**
     * Creates a new ResponseHandler with a user-supplied looper. If
    ...
    /**
     * Creates a new ResponseHandler and decide whether the callbacks
