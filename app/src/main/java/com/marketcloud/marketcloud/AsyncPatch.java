 ...
 * AsyncPatch class. <br />
 * <br />
 * Performs an asynchronous HTTP PATCH operation, creating a background thread that executes a blocking call,
 * resulting in an asynchronous call.
 */
public class AsyncPatch extends AsyncTask<String, Void, JSONArray> {

    private JSONArray ja;
    private boolean keepAlive = true;
    private Context context;

    public AsyncPatch(Context ct) {
        context = ct;
    }


    /**
     * Processes an HTTP PATCH request in background.
     *
    ...
    protected JSONArray doInBackground(String... params) {
        ...
        try {
            ...
            client.patch(context, params[0], new StringEntity("[" + params[2] + "]"), "application/json", rh);  //url, cart
